                ...
                <div className="row">
                    ...
                    <div className="col-md-6 mb-5">
                        <div className="portfolio-item">
                            ...
                            <a href="https://yebirhan-inventoryapp.vercel.app" target="_blank"><img className="img-fluid" src={portfolio1} alt="..." /></a>
                    ...
                    <div className="col-md-6 mb-5 mt-5">
                        <div className="portfolio-item">
                            ...
                            <h5 className="text-center p-3" style={{ color: "black", fontWeight: "bold" }}>Event Management app</h5>
